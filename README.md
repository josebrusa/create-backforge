...
```bash
npm install -g @cli/create-backforge
# or
pnpm add -g @cli/create-backforge
# or
yarn global add @cli/create-backforge
```
...
```bash
# Interactive mode
pnpm create @cli/backforge

# With project name
pnpm create @cli/backforge my-api
```
